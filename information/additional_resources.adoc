...
* https://docs.netapp.com/us-en/astra-control-center-2304/["Astra Control Center 23.04 文件"^]
+
客戶內部部署 Astra Control Center 軟體 23.04 版本的文件。

* https://docs.netapp.com/us-en/astra-control-service/["Astra Control Service文件"^]
+
公有雲中最新版本的 Astra Control Service 軟體文件。
